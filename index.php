            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://semicolon2.blogspot.com/" target="_blank">blog</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 site-title">
                        ...
                        <h1 class="title-text text-uppercase">I am Ahmad</h1>
...
<!--                                 <button type="button" class="btn button primary-button mr-4 text-uppercase">hire
                                    me</button> -->
                                <a href="https://doc-0s-98-apps-viewer.googleusercontent.com/viewer/secure/pdf/pugl7f0r0kordgn3b6m9h96kqr1bll1l/vsg34fsegobs1f1ems5nq91f9r9o661u/1602200025000/gmail/05564171809897608849/ACFrOgBGTZdGU3z5fvYY6j-dJuC3JpiPGm-WHjvbuyyfwa1uW_-y7FjA2BXtnd0aodB8wpTAgwxC04sQP4OH3Id4xp_at_RR8SWfyhDjU_B0ZdG3ki531qdZ0qAl90Q=?print=true&nonce=m8aj7hrc2ens6&user=05564171809897608849&hash=oc1e83njrf8srhbgcjqaguec9vs39b70" target="_blank"><button type="button"  class="btn button secondary-button text-uppercase">Get cv</button></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 about-title">
                        ...
                        <a href="https://doc-0s-98-apps-viewer.googleusercontent.com/viewer/secure/pdf/pugl7f0r0kordgn3b6m9h96kqr1bll1l/vsg34fsegobs1f1ems5nq91f9r9o661u/1602200025000/gmail/05564171809897608849/ACFrOgBGTZdGU3z5fvYY6j-dJuC3JpiPGm-WHjvbuyyfwa1uW_-y7FjA2BXtnd0aodB8wpTAgwxC04sQP4OH3Id4xp_at_RR8SWfyhDjU_B0ZdG3ki531qdZ0qAl90Q=?print=true&nonce=m8aj7hrc2ens6&user=05564171809897608849&hash=oc1e83njrf8srhbgcjqaguec9vs39b70" target="_blank"><button type="button" class="btn button primary-button text-uppercase">Download cv</button></a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="experience-area">
                            ...
                            <div class="d-flex flex-row flex-wrap call-area">
                                ...
                                <div class="call-now">
                                    ...
                                    <span class="font-roboto py-2">(0020)01011445235</span>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="">
                <div class="site-logo text-center py-4">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=100031577522253" target="_blank"><i class="fab fa-facebook"></i>Ahmad Mostafa</a>
                </div>
                <div class="social text-center">
                    <h5 class="text-uppercase">Follow me</h5>
                    <a href="https://www.facebook.com/profile.php?id=100031577522253" target="_blank"><i class="fab fa-facebook"></i></a>
                    <a href="https://www.instagram.com/ahmad_mostafa44/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>
                    <!-- <a href="#"><i class="fab fa-youtube"></i></a> -->
                    <a href="https://twitter.com/ProgrammerAhma1" target="_blank"><i class="fab fa-twitter"></i></a>
                    <a href="https://www.linkedin.com/in/ahmad-mostafa-b8340880/" target="_blank"><i class="fab fa-linkedin"></i></a>
                </div>
                <div class="copyrights text-center">
                    <p class="para">
                        Copyright ©2019 All rights reserved | This template is made with by
                        <a href="#"><span style="color: var(--primary-color);">Ahmad Mostafa</span></a>
                    </p>
                </div>
            </div>
        </div>
